                ...
                <form onSubmit={handleSubmit} style={{ border: '2px solid grey' , padding: '10px'}}>
                    <div class="input-group mb-3">
                        <input style={{ border: '2px solid grey' }}
                            type="text" class="form-control" placeholder="Id" aria-label="Server"
                            onChange={(e) => setid(e.target.value)} value={id} required />
                    </div>
                    <div class="input-group mb-3">
                        <input style={{ border: '2px solid grey' }}
                            type="text" class="form-control" placeholder="Title" aria-label="Server"
                            onChange={(e) => settitle(e.target.value)} value={title} />
                    </div>
                    <div class="input-group mb-3">
                        <input style={{ border: '2px solid grey' }}
                            type="text" class="form-control" placeholder="Description" aria-label="Server"
                            onChange={(e) => setdescrip(e.target.value)} value={descrip} />
                    </div>
                    <div style={{ margin: '10px' }}></div>
                    <div class="input-group mb-3">
                        <input style={{ border: '2px solid grey' }}
                            type="text" class="form-control" placeholder="Contact tel or e-mail" aria-label="Recipient's username" aria-describedby="basic-addon2"
                            onChange={(e) => setcontact(e.target.value)} value={contact} />
                    </div>
                    <div className="dropdown-result" >
                        <label style={{ margin: '10px' }}>Update Status:</label>
                        <select style={{ border: '2px solid grey' }} className="form-select" onChange={(e) => setstatus(e.target.value)} required>
